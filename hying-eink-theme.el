;; hying-eink-theme.el --- HYing's EMACS grayscale color theme for eink monitor
;;
;; Copyright 2025 Huang Ying <huang.ying.caritas@gmail.com>
;;
;; Author: Huang Ying <huang.ying.caritas@gmail.com>
;;
;; This is based on the TAO theme in http://github.com/11111000000/tao-theme-emacs
;; and adjusted for eink monitor
;;
...
(deftheme hying-eink "HYing's eink theme")

(defcustom hying-eink-theme-use-boxes t
  "Non-nil means hying-eink-theme is allowed to use borders."
  :type 'boolean
  :group 'hying-eink-theme)

(defcustom hying-eink-theme-use-height nil
  "Non-nil means hying-eink-theme is allowed to customize height."
  :type 'boolean
  :group 'hying-eink-theme)

(defun hying-eink-boxed (color)
  (if hying-eink-theme-use-boxes
      `(:color ,color  :line-width -1) nil))

(defun hying-eink-theme-height (height)
  (if hying-eink-theme-use-height
      height 1.0))

(defun hying-apply-eink-theme ()
  (let ((class '((class color) (min-colors 255)))
	(color-0 "#ffffff")
	(color-1 "#ebebeb")
	(color-2 "#e0e0e0")
	(color-3 "#dbdbdb")
    ...
    (custom-theme-set-faces
     ...
     `(default                                          ((t (:foreground ,color-15 :background ,color-0))))
     `(italic                                           ((t (:italic t ))))
     `(variable-pitch                                   ((t (:foreground ,color-9 :height ,(hying-eink-theme-height 1.1) :variable-pitch t))))
     `(parenthesis                                      ((t (:foreground ,color-7))))
     `(hl-paren-face                                    ((t (:foreground ,color-12 :background ,color-4))))
     `(cursor                                           ((t (:foreground ,color-13 :background ,color-13))))
     `(escape-glyph                                     ((t (:foreground ,color-13 :bold t))))
     `(header-line                                      ((t (:foreground ,color-14 :background ,color-4 :box nil :height ,(hying-eink-theme-height 1.0)))))
     ...
     `(error                                            ((t (:foreground ,color-14 :background ,color-4 :weight bold))))
     ;; compilation
     ...
     ;; isearch
     `(isearch                                          ((t (:foreground ,color-13 :weight bold :background ,color-4))))
     `(isearch-fail                                     ((t (:foreground ,color-14 :background ,color-5))))
     `(lazy-highlight                                   ((t (:foreground ,color-12 :weight bold :background ,color-4))))
     `(menu                                             ((t (:foreground ,color-13 :background ,color-4))))
     `(minibuffer-prompt                                ((t (:foreground ,color-0 :background ,color-9 :inherit fixed-pitch ))))
     `(mode-line                                        ((,class (:foreground ,color-13 :background ,color-3 :box nil :height ,(hying-eink-theme-height 1.0)))))
     `(mode-line-inactive                               ((t (:foreground ,color-11 :background ,color-4 :box nil :height ,(hying-eink-theme-height 1.0)))))
     ...
     ;; font lock
     `(font-lock-builtin-face                           ((t (:foreground ,color-15 :italic nil  :weight semi-bold ))))
     `(font-lock-keyword-face                           ((t (:foreground ,color-14 :weight semi-bold))))
     `(font-lock-comment-face                           ((t (:foreground ,color-13 :weight normal :italic t :variable-pitch nil :height ,(hying-eink-theme-height 1.1) :inherit variable-pitch ))))
     `(font-lock-comment-delimiter-face                 ((t (:foreground ,color-11))))
     `(font-lock-constant-face                          ((t (:foreground ,color-13 :weight normal :italic nil))))
     `(font-lock-doc-face                               ((t (:foreground ,color-12 :weight normal :italic t))))
     `(font-lock-function-name-face                     ((t (:foreground ,color-14 :box ,(hying-eink-boxed color-8) :italic nil :weight normal  ))))
     `(font-lock-variable-name-face                     ((t (:foreground ,color-13 :italic nil :slant normal))))
     `(font-lock-negation-char-face                     ((t (:foreground ,color-15))))
     `(font-lock-preprocessor-face                      ((t (:foreground ,color-12))))
     `(font-lock-regexp-grouping-construct              ((t (:foreground ,color-14 :weight bold))))
     `(font-lock-regexp-grouping-backslash              ((t (:foreground ,color-11 :weight bold))))
     `(font-lock-string-face                            ((t (:foreground ,color-14 :italic t))))
     `(font-lock-type-face                              ((t (:foreground ,color-13 :italic t))))
     ...
     `(newsticker-extra-face                            ((t (:foreground ,color-7 :height ,(hying-eink-theme-height 0.8)))))
     ...
     `(ace-jump-face-foreground                         ((t (:foreground ,color-11 :background ,color-0 :inverse-video nil))))
     ;; anzu
     ...
     `(ac-slime-menu-face                               ((t (:background ,color-8 :foreground ,color-0))))
     ...
     `(diff-header                                      ((,class (:background ,color-7)) (t (:background ,color-11 :foreground ,color-3))))
     `(diff-file-header                                 ((,class (:background ,color-7 :foreground ,color-13 :bold t)) (t (:background ,color-11 :foreground ,color-3 :bold t))))
     ;; diff-hl
     `(diff-hl-insert                                   ((,class (:background ,color-11)) (t (:background ,color-8))))
     `(diff-hl-change                                   ((t (:background ,color-11))))
     `(diff-hl-delete                                   ((,class (:background ,color-10)) (t (:background ,color-8))))
     `(diff-hl-dired-insert                             ((,class (:background ,color-11)) (t (:background ,color-8))))
     `(diff-hl-dired-change                             ((t (:background ,color-11))))
     ...
     `(gnus-summary-high-read                           ((t (:foreground ,color-10 :weight semi-bold))))
     `(gnus-summary-high-ticked                         ((t (:foreground ,color-15 :weight bold))))
     `(gnus-summary-high-unread                         ((t (:foreground ,color-15 :weight semi-bold))))
     ...
     `(gnus-summary-low-unread                          ((t (:foreground ,color-15 :weight semi-bold))))
     ...
     `(gnus-summary-normal-unread                       ((t (:foreground ,color-13 :weight semi-bold))))
     `(gnus-summary-selected                            ((t (:foreground ,color-13 :weight bold :italic t))))
     ...
     `(gnus-x                                           ((t (:background ,color-11 :foreground ,color-3))))
     ;; guide-key
     ...
     `(helm-source-header                               ((t (:foreground ,color-3 :background ,color-11 :underline nil :box (:color ,color-11 :line-width 1 :style released-button )))))
     ...
     `(helm-ff-prefix                                   ((t (:foreground ,color-3 :background ,color-11 :weight normal))))
     ...
     `(js2-function-call                                ((t (:foreground ,color-12 :underline nil :box ,(hying-eink-boxed color-6)))))
     ...
     `(jabber-title-small                               ((t (:height ,(hying-eink-theme-height 1.1) :weight bold))))
     `(jabber-title-medium                              ((t (:height ,(hying-eink-theme-height 1.2) :weight bold))))
     `(jabber-title-large                               ((t (:height ,(hying-eink-theme-height 1.3) :weight bold))))
     ;; ledger-mode
     ...
     `(paren-face-mismatch                              ((t (:foreground ,color-0 :underline t :background ,color-6 ))))
     ...
     `(diary                                          ((t (:background ,color-4 :box ,(hying-eink-boxed color-7)))) t)
     ;; org-mode
     ...
     `(org-document-title                               ((t (:foreground ,color-12 :height ,(hying-eink-theme-height 0.8) :bold nil))))
     `(org-document-info                                ((t (:foreground ,color-7 :height ,(hying-eink-theme-height 0.8)))))
     `(org-document-info-keyword                        ((t (:foreground ,color-7 :height ,(hying-eink-theme-height 0.8)))))
     ...
     `(org-level-1                                      ((t ( :height ,(hying-eink-theme-height 1.5) :inherit org-heading))))
     `(org-level-2                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     `(org-level-3                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     `(org-level-4                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     `(org-level-5                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     `(org-level-6                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     `(org-level-7                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     `(org-level-8                                      ((t ( :height ,(hying-eink-theme-height 1.1) :inherit org-heading))))
     ...
     `(org-meta-line                                    ((t (:background ,color-4 :foreground ,color-7 :height ,(hying-eink-theme-height 0.7) :inherit fixed-pitch :box nil))))
     `(org-drawer                                    ((t (:background ,color-4 :foreground ,color-7 :height ,(hying-eink-theme-height 0.7) :inherit fixed-pitch :box nil))))
     `(org-block-begin-line                             ((t (:background ,color-4 :foreground ,color-7 :height ,(hying-eink-theme-height 0.7) :inherit fixed-pitch :box nil))))
     `(org-block-end-line                               ((t (:background ,color-4 :foreground ,color-7 :height ,(hying-eink-theme-height 0.7) :inherit fixed-pitch))))
     ...
     `(org-block-background                             ((t (:foreground ,color-4 :height ,(hying-eink-theme-height 0.9) :inherit fixed-pitch))))
     `(org-block                                        ((t (:background ,color-4  :height ,(hying-eink-theme-height 0.9) :inherit fixed-pitch))))
     ;; outline
     `(outline-1                                        ((t ( :height ,(hying-eink-theme-height 1.3) :italic nil :inherit variable-pitch :variable-pitch t))))
     `(outline-2                                        ((t ( :height ,(hying-eink-theme-height 1.2) :italic nil :inherit variable-pitch :variable-pitch t :underline nil))))
     `(outline-3                                        ((t ( :height ,(hying-eink-theme-height 1.1) :italic nil :inherit variable-pitch :variable-pitch t))))
     `(outline-4                                        ((t ( :height ,(hying-eink-theme-height 1.1) :italic nil :inherit variable-pitch :variable-pitch t :underline nil))))
     `(outline-5                                        ((t ( :height ,(hying-eink-theme-height 1.1) :italic nil :inherit variable-pitch))))
     `(outline-6                                        ((t ( :height ,(hying-eink-theme-height 1.1) :italic t :inherit org-heading))))
     `(outline-7                                        ((t ( :height ,(hying-eink-theme-height 1.1) :italic t :inherit org-heading))))
     `(outline-8                                        ((t ( :height ,(hying-eink-theme-height 1.1) :italic t :inherit org-heading))))
     ;; p4
     ...
     `(proof-highlight-dependency-face                  ((t (:foreground ,color-4 :background ,color-11))))
     ...
     ;; show-paren
     `(show-paren-mismatch                              ((t (:foreground ,color-0 :background ,color-11 :weight bold))))
     ...
     `(w3m-current-anchor                               ((t (:foreground ,color-0 :background ,color-10 :underline nil :weight bold))))
     ...
     `(w3m-tab-background                               ((t (:foreground ,color-0 :background ,color-9 :underline nil :weight normal))))
     `(w3m-tab-unselected-retrieving                    ((t (:foreground ,color-0 :background ,color-9 :underline nil :weight normal))))
     `(w3m-tab-selected-background-face                 ((t (:foreground ,color-0 :background ,color-11 :underline nil :weight bold))))
     `(w3m-tab-selected-retrieving                      ((t (:foreground ,color-0 :background ,color-11 :underline nil :weight bold))))
     `(w3m-lnum                                         ((t (:foreground ,color-0 :background ,color-9 :underline nil :bold t ))))
     ...
     `(whitespace-space-after-tab                       ((t (:background ,color-11 :foreground ,color-7))))
     ;; wanderlust
     ...
     `(markdown-link-face                               ((t (:underline nil :foreground ,color-13 :height ,(hying-eink-theme-height 1.0)))))
     `(markdown-url-face                                ((t (:underline t :foreground ,color-10))))
     `(markdown-pre-face                                ((t (:inherit org-block :height ,(hying-eink-theme-height 0.8)))))
     `(markdown-language-keyword-face                   ((t (:inherit fixed-pitch :height ,(hying-eink-theme-height 0.8) :background ,color-8 :foreground ,color-1))))
     ...
     `(markdown-table-face                              ((t (:inherit fixed-pitch :height ,(hying-eink-theme-height 0.8)))))
     ;; swoop
     ...
     `(company-preview                                  ((t (:background ,color-3 :foreground ,color-12))))
     ...
     `(company-tooltip                                  ((t (:background ,color-2 :foreground ,color-14 :inherit fixed-pitch))))
     `(company-tooltip-annotation                       ((t (:inherit company-tooltip :foreground ,color-11 :inherit fixed-pitch))))
     `(company-tooltip-annotation-selection             ((t (:inherit company-tooltip-selection :foreground ,color-12))))
     ...
     `(company-tooltip-selection                        ((t (:inherit company-tooltip :background ,color-7 :foreground ,color-0))))
     ...
     ;; avy
     `(avy-lead-face                                    ((t (:background ,color-8 :foreground ,color-0 :bold t))))
     `(avy-lead-face-0                                  ((t (:background ,color-9  :foreground ,color-0  :bold t))))
     `(avy-lead-face-1                                  ((t (:background ,color-10  :foreground ,color-0 :bold t))))
     `(avy-lead-face-2                                  ((t (:background ,color-11  :foreground ,color-0 :bold t))))
     `(avy-background-face                              ((t (:background ,color-3  :foreground ,color-7 :bold t))))
     ;; ace-window
     `(aw-leading-char-face                             ((t (:background ,color-8 :foreground ,color-0 :bold t))))
     ...
     `(circe-prompt-face                              ((t (:foreground ,color-0 :background ,color-9 :inherit fixed-pitch))))
     ...
     `(lsp-ui-sideline-current-symbol ((t (:background ,color-4  :foreground ,color-9 :box ,(hying-eink-boxed color-8)))))
     ...
     `(lsp-ui-sideline-code-action ((t (:background ,color-3  :foreground ,color-8  :weight normal :box ,(hying-eink-boxed color-6)))))
     ...
     `(notmuch-tag-flagged                           ((t (:foreground ,color-8 :box ,(hying-eink-boxed color-8)))))
     `(notmuch-tag-unread                            ((t (:box ,(hying-eink-boxed color-9)))))
    ...
    (custom-theme-set-variables
     'hying-eink
     ;; ansi-color
     `(ansi-color-names-vector [,color-0
				,color-10
				,color-9
				,color-13
				,color-11
...
(hying-apply-eink-theme)

(provide-theme 'hying-eink)

(provide 'hying-eink-theme)
